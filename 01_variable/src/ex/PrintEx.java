...
public class PrintEx {
	...
	public static void main(String[] args) {
		...
		System.out.printf("%s/%f", name, height); // 홍길동/212.50000
		
		// 문자열 6칸 오른쪽 정렬 : %6s
		System.out.println();
		System.out.printf("%6s/%f", name, height); // ㅁㅁㅁ홍길동/212.50000
		
		// 문자열 6칸 왼쪽 정렬 : %-6s
		System.out.println();
		System.out.printf("%-6s/%f", name, height); // 홍길동ㅁㅁㅁ/212.50000
		
		// 소수점 아래로 1자리 : %.1f
		// -> 둘째 자리에서 반올림
		double num = 1.25;
		System.out.println();
		System.out.printf("%s/%.1f", name, num); // 홍길도 / 1.3
