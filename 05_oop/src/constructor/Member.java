...
public class Member {
	...
	public Member() {
		...
		// Member 객체가 생성될 때 pringln() 구문을 수행
...
//	public String method() {} // 반환형 다름 -> 중복 O
	 ...
	 *   *** 오버로딩 성립 조건 ***
	 *   1) 메서드의 이름이 똑같아야 한다
	 *   2) 매개 변수의 개수, 자료형 순서 중 하나라도 달라야 함
	 * */
	
	public void method(int a) {} // 매배 변수 개수 다름
	public void method(int a, String b) {} // 매개 변수 개수
	public void method(String b, int a) {} // 자료형 순서 다름
	public void methid(String b, long a) {} // 자료형 다름
