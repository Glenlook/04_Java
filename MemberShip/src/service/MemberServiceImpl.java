...
public class MemberServiceImpl implements MemberService{
	...
	@Override
	public String updatePhone(Member target, String newPhone) throws IOException {
	...
	public String removeMember(Member target) throws IOException {
		...
		return target.getName() + " 회원님이 탈퇴 처리 되었습니다";
	}
